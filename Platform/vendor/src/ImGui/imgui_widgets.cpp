...
#include "ImGui/imgui_internal.h" // Full Path ---> Engine/Platform/Vendor/include/ImGui/.h
...
namespace ImStb
{
#include "ImGui/imstb_textedit.h" // Full Path ---> Engine/Platform/Vendor/include/ImGui/.h
}
